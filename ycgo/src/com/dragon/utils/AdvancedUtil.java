...
public class AdvancedUtil {
	...
	//
	// ResultList resultList=mapPosition.setResult();
	// mapPosition.getStatus();
	// list=ResultList

	// System.out.println(String.format("stauts:%s,message:%s,result:%s",
	...
	/*
	 * public static void main(String args[]) { // 获取接口访问凭证 String accessToken =
	 * CommonUtil.getToken("wxa42ebfb1fa86c5c6",
	 * "d3435419b50d0bed15c9abc3b8ce0781").getAccessToken();
	 * System.out.println("现在的accessToken的值为=>"+accessToken); // Map<String,
	 * String> requestMap = MessageUtil.parseXml(request);
	 * 
	 * //System.out.println(getPosition(String.format("", 118.116882,
	 * 24.523195)));
	 *//**
	 * 发送客服消息（图文消息）
	 */
	 ...
	 * makeNewsCustomMessage("oEdzejiHCDqafJbz4WNJtWTMbDcE", list); // 发送客服消息 //
	 ...
	 * 111111); // 临时二维码的ticket System.out.println(weixinQRCode.getTicket()); //
	 * 临时二维码的有效时间 System.out.println(weixinQRCode.getExpireSeconds());
	 *//**
	 * 根据ticket换取二维码
	 */
	/*
	 ...
	 * ; String savePath = "G:/weixindownloadtestfile"; // 根据ticket换取二维码
	 ...
	 * "oEdzejiHCDqafJbz4WNJtWTMbDcE"); System.out.println("OpenID：" +
	 * user.getOpenId()); System.out.println("关注状态：" + user.getSubscribe());
	 * System.out.println("关注时间：" + user.getSubscribeTime());
	 * System.out.println("昵称：" + user.getNickname()); System.out.println("性别："
	 * + user.getSex()); System.out.println("国家：" + user.getCountry());
	 * System.out.println("省份：" + user.getProvince()); System.out.println("城市："
	 * + user.getCity()); System.out.println("语言：" + user.getLanguage());
	 ...
	 */
	/*
	 * List<WeixinGroup> groupList = getGroups(accessToken); // 循环输出各分组信息 for
	 * (WeixinGroup group : groupList) {
